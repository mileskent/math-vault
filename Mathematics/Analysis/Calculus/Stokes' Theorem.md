...
![[Pasted image 20251217011400.png|300]]
$$
\int_{C} \vec{F} \cdot d \vec{r} = \iint_{S} (\nabla  \times \vec{F}) \cdot d \vec{S}
$$
* [[Line Integral]] is equal to [[Surface Integral#Vector Surface Integral]] of the [[Curl]]
* "Draw a loop around it and it tells you how much swirly is in it"