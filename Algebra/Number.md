...
| [[Irrational Number]] | $\mathbb{I}$ | Numbers that cannot be fractions (non-repeating decimals).               | $\pi, e, \sqrt{2}$      |
| [[Real Number]]       | $\mathbb{R}$ | All points on the continuous number line ($\mathbb{Q} \cup \mathbb{I}$). | $1.5, \pi, -22$         |
